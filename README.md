...
- **For this project i'm using databricks community edition**
  ...
  - Create a staging scheme with staging tables and insert data into these staging tables using delta file location. Refer to [load-step.ipynb](azure-data-lakehouse-dbricks\load-step.ipynb)
  ...
  - Create Date, Rider, Station and Time dimensions. 
    - For Date dimension refer to [date-dim.ipynb](azure-data-lakehouse-dbricks\dimensions\date_dim.ipynb)
    - For Rider dimension refer to [rider-dim.ipynb](azure-data-lakehouse-dbricks\dimensions\rider_dim.ipynb)
    - For Station dimension refer to [station-dim.ipynb](azure-data-lakehouse-dbricks\dimensions\station_dim.ipynb)
    - For Time dimension refer to [time-dim.ipynb](azure-data-lakehouse-dbricks\dimensions\time_dim.ipynb)
  - Create Trips and Payments facts
    - For payments fact refer to [payments-fact.ipynb](azure-data-lakehouse-dbricks\facts\payments_fact.ipynb)
    - For Trips fact refer to [trips-fact.ipynb](azure-data-lakehouse-dbricks\facts\trips_fact.ipynb)
